...
// 22Bet – same LineFeed platform as 1xBet, different domain (22bet.com)
class TwentyTwoBetScraper extends ScraperBase {
  TwentyTwoBetScraper() : super(bookmakerById('22bet')!);
      ...
      for (final e in vals) {
        ...
        switch (market) {
          ...
          case 'btts':
            ...
            break;
          case 'over_under':
            for (final line in ['1.5','2.5','3.5']) {
              final h2 = _d(e['Coff1'] ?? e['O1']); final a2 = _d(e['Coff2'] ?? e['O2']);
              if (h2 != null && a2 != null) out.add(_ev('${id}_ou_$line', home, away, league, sport, market, 'Over/Under $line', {'Over':h2,'Under':a2}));
              break;
            }
            break;
        }
